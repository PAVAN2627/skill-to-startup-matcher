...
// Check if job_id is provided (for both job posts and startup recommendations)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    error_log("Startup recommendation application submission - Student ID: {$student_id}, Job ID: {$job_id}");
